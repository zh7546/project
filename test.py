...
parser.add_argument('--save_img', action='store_true', default="true",help='save result images')
parser.add_argument('--ckpt_pth', type=str, default='./ckpt/net_g_latest.pth', help='model path')
parser.add_argument('--result_dir', type=str, default='results/motionDeblur', help='results dir')
